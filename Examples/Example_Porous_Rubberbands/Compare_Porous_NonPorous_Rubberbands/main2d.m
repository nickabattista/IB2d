...
grid_Info(8) = params(26);          % Print Dump (How often to plot)
grid_Info(9) = params(27);          % Plot in Matlab? (1=YES,0=NO) 
grid_Info(10) = params(28);         % Plot LAGRANGIAN PTs ONLY in Matlab
grid_Info(11) = params(29);         % Plot LAGRANGIAN PTs + VELOCITY FIELD in Matlab
grid_Info(12) = params(30);         % Plot LAGRANGIAN PTs + VORTICITY colormap in Matlab
grid_Info(13) = params(31);         % Plot LAGRANGIAN PTs + MAGNITUDE OF VELOCITY colormap in Matlab
grid_Info(14) = params(32);         % Plot LAGRANGIAN PTs + PRESSURE colormap in Matlab
