...
dt = 1e-5;      % Time-step
Tfinal = 2.1;   % Final time in simulation
pDump=1000;       % Note: 'print_dump' should match from input2d

% DATA ANALYSIS INFO %
start=1;                             % 1ST interval # included in data analysis
finish=209;                           % LAST interval # included in data analysis 
...
pathViz = '/Users/nick_battista/Desktop/BioMath_HT_Electro_Sims/Wo0pt1/viz_IB2d_d10_Wo0pt1';

old_path = '/Users/nick_battista/Desktop/IB2d/data_analysis/analysis_in_matlab/Perform_Analysis_Here';
