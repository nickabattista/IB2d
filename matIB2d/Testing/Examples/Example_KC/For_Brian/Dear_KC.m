...
[xa,ya] = give_Me_The_Letter_Please(ds,len,'a',xC-0.42,yC);
[xt,yt] = give_Me_The_Letter_Please(ds,len,'t',xC-0.54,yC);
%[xEx1,yEx1] = give_Me_The_Letter_Please(ds,1.2*len,'!',xC-0.54,yC);
[xEx2,yEx2] = give_Me_The_Letter_Please(ds,1.2*len,'!',xC-0.63,yC);
...
xBL3 = 0:ds:Lx/8+2*ds; xBL3 = xBL3 + 7/16*Lx -ds;
yBL3 = 0.9*ones(1,length(xBL3));
yTL3 = 0.1*ones(1,length(xBL3));


xLag = [xH xi xK xa xt xEx2 xBL xBL2 xBL3 xBL(1:end-1) xBL2 xBL3(1:end-1)];
yLag = [yH yi yK ya yt yEx2 yBL yBL2 yBL3 yTL(1:end-1) yTL2 yTL3(1:end-1)];
