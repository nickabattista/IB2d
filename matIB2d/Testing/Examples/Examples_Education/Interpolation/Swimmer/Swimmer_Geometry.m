...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION: creates the Anguilliform Swimmer geometry and prints associated input files
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
yBlock = ds:4*ds:L-ds;
xBlock = zeros(1,length(yBlock))+ds;


fprintf('\n# of Lag Pts. in Swimmer: %d\n',length(xLag));
fprintf('# of Lag Pts. in Domain Edge Flow Blocker: %d\n',length(xBlock));
...
%
% PRINT INPUT FILES (.vertex, .spring, .beam, .target, etc) %
%

% print vertices
print_Lagrangian_Vertices([xLag xBlock],[yLag yBlock],struct_name);
...
k_Target = 1e6;
nBefore = length(xLag); % Counts pts in swimmer for bookkeeping for .target file
