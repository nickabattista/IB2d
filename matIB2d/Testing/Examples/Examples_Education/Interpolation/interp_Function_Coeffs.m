...
figure(1)
for i=1:length(t)
    plot(t(i),g(coeffs,t(i),p1,p2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('g(t)');
set(gca,'FontSize',18)
...
figure(2)
for i=1:length(t)
    plot(t(i),gP(coeffs,t(i),p1,p2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('dg/dt');
set(gca,'FontSize',18)
...
figure(3)
for i=1:length(t)
    plot(t(i),gPP(coeffs,t(i),p1,p2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('d^2g/dt^2');
set(gca,'FontSize',18)
