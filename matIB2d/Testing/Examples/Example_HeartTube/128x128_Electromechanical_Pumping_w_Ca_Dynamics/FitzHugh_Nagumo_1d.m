...
numPtsAlongTube = 155;   % # of Lag. Muscle Pts Along Tube 
ind_Start = 309;         % first index for muscle between tube in spring count
ind_End = 463;           % last index for muscle between tube in spring count
...
numFHN = 1;          % # that relates # of time-steps of FHN to IBM
...
fprintf('     --> Solving Electrophysiology Model\n');
...
fprintf('     --> Finished calculating Electrophysiology Model\n');
