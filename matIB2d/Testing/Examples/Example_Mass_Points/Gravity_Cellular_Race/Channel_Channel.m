...
xLag = [xLag_C1 xLag_C2 xLag_C3]; % Add xLagPts from Circle to xLag Pt. Vector (*no springs or beams*)
yLag = [yLag_C1 yLag_C2 yLag_C3]; % Add xLagPts from Circle to xLag Pt. Vector (*no springs or beams*)
