...
% Prints .spring file!
k_Spring = 2.5e4;
print_Lagrangian_User_Force(xLag,yLag,k_Spring,ds_Rest,struct_name);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION: prints USER-FORCE MODEL INFO points to a file called
%           rubberband.user_force
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function print_Lagrangian_User_Force(xLag,yLag,k_Spring,ds_Rest,struct_name)

    N = length(xLag);

    spring_fid = fopen([struct_name '.user_force'], 'w');

    fprintf(spring_fid, '%d\n', N );

    %FORCE MODEL BETWEEN VERTICES
    for s = 1:N
            if s < N         
