...
plot(xLag2,yLag2,'k-'); hold on;
plot(xLag2,yLag2,'m*'); hold on;
xlabel('x'); ylabel('y');
axis square;
...
% Prints .vertex file!
print_Lagrangian_Vertices(xLags,yLags,struct_name);
...
for i=1:N
    ...
    yLag(i) = 1.0 + rmin * sin( 2*pi/N*(i-1) );
