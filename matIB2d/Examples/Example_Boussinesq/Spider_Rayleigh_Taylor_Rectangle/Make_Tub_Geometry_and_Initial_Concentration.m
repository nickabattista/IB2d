...
[xLag,yLag,xSpider,ySpider,Concentration] = give_Me_Immsersed_Boundary_Geometry_and_Concentration(ds,Nx,Lx,dx);
...
print_Lagrangian_Mass_Pts([xLag xSpider],k_Mass,Mass,struct_name,length(xLag))
...
function [xLag,yLag,xSpider,ySpider,C] = give_Me_Immsersed_Boundary_Geometry_and_Concentration(ds,Nx,Lx,dx)
...
xSpider = 0.325:0.025:0.675;
ySpider = 0.5*ones(1,length(xSpider));
