...
N = 64;                            % # of Cartesian grid meshwidths
...
print_Lagrangian_Vertices_Phases(yLag,yLag2,struct_name);
...
% print beams
k_Beam = 1.0363359375000002e+8;   % beam stiffness constant (Newton m^2)
...
function print_Lagrangian_Vertices_Phases(yLag,yLag2,struct_name)
