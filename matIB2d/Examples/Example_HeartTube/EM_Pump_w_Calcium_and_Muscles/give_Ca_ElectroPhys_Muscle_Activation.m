...
function Fm = give_Ca_ElectroPhys_Muscle_Activation(v,LF,LFO,SK,a,b,Fmax,ct,ith_muscle,electro_potential)
...
af_Val = 1e1*electro_potential(floor(ct+1),ith_muscle);%give_Traveling_Triggering_Coefficient(current_time,xLag,xPt);
