...
[Concentration,X,Y]= give_Me_Initial_Concentration(L,Nx,dx,x,y);
...
%     XbL=(C1(1)*s.^3+C1(2)*s.^2+C1(3)*s+C1(4));
...
function [C,X,Y] = give_Me_Initial_Concentration(Lx,Nx,dx,xLag,yLag)
