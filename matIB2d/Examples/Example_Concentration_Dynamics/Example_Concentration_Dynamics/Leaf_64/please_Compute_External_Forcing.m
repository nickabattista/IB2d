...
% SOLELY HORIZONTAL FLOW PROFILE
uX_Tar = Umax * tanh(t); % * ( (Ly/2+w/2) - ( y ) )*( (Ly/2-w/2) - ( y ) ); % Only external forces in x-direction

% PARABOLIC FLOW PROFILE
%uX_Tar = -Umax * (tanh(2*t)) * ( (Ly/2+w/2) - ( y ) )*( (Ly/2-w/2) - ( y ) ); % Only external forces in x-direction

% No external forces in y-direction
uY_Tar = 0;                                                           
