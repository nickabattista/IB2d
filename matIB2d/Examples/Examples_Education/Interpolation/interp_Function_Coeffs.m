...
figure(1)
for i=1:length(x)
    plot(x(i),g(coeffs,x(i),x1,x2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('g_0(t)');
set(gca,'FontSize',18)
...
figure(2)
for i=1:length(x)
    plot(x(i),gP(coeffs,x(i),x1,x2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('dg_0/dt');
set(gca,'FontSize',18)
...
figure(3)
for i=1:length(x)
    plot(x(i),gPP(coeffs,x(i),x1,x2),'*','MarkerSize',ms); hold on;
end
xlabel('t');
ylabel('d^2g_0/dt^2');
set(gca,'FontSize',18)
