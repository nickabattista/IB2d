...
[x1,y1,x2,y2,n1,n2] = please_Take_Out_Points(x1,y1,x2,y2);
...
plot(x1,y1,'r-'); hold on;
plot(x1,y1,'*'); hold on;
%plot(x1(1150:1400),y1(1150:1400),'r*'); hold on;
plot(x1(750:950),y1(750:950),'r*'); hold on;
...
k_Spring = 1e3;
ds_Rest = Lx/(2*Nx);
print_Lagrangian_Springs(x1,y2,k_Spring,ds_Rest,struct_name,n1,n2);
...
function print_Lagrangian_Springs(xLag,yLag,k_Spring,ds_Rest,struct_name,n1,n2)
...
function [x1,y1,x2,y2,n1,n2] = please_Take_Out_Points(x1,y1,x2,y2)
