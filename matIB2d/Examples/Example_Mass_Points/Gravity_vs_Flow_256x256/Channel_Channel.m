...
y0 = 0.55;                      % y-Center for Cylinder
r = w/6;                       % Radii of Cylinder
struct_name = 'channel'; % Name for .vertex, .spring, etc files.


% Call function to construct geometry
[yLag_T,xLag_T] = give_Me_Channel_Immsersed_Boundary_Geometry(ds,L,w,Lx,Ly);
[xLag_C,yLag_C] = give_Me_Cylinder_Immsersed_Boundary_Geometry(ds,r,x0,y0);

%Upper Channel / Cell
xLag_T1 = xLag_T+0.3; yLag_T1 = yLag_T;
xLag_C1 = xLag_C+0.3; yLag_C1 = yLag_C;
...
%Lower Channel / Cell
xLag_T3 = xLag_T-0.3; yLag_T3 = yLag_T;
xLag_C3 = xLag_C-0.3; yLag_C3 = yLag_C;
...
Mass = [2.5e0 0.875e-1 6.5e-4];          % "MASS" value for 'ghost' nodal movement
