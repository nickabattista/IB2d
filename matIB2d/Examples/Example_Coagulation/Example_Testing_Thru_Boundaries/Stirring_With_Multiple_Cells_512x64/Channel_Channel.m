...
xLag_C4 = xLag_C+15*r;   yLag_C4 = yLag_C+3*r;              % Bubble 1
xLag_C5 = xLag_C+20.5*r; yLag_C5 = yLag_C-2*r;   % Bubble 2
xLag_C6 = xLag_C-6.5*r;  yLag_C6 = yLag_C-2.5*r;  % Bubble 3


% Combine Geometry Files into ONE Vector
%xLag = [xLag_C1 xLag_C2 xLag_C3 xLag xLag_V];
%yLag = [yLag_C1 yLag_C2 yLag_C3 yLag yLag_V];
xLag = [xLag_C1 xLag_C2 xLag_C3 xLag_C4 xLag_C5 xLag_C6 xLag_V];
yLag = [yLag_C1 yLag_C2 yLag_C3 yLag_C4 yLag_C5 yLag_C6 yLag_V];
yLag = yLag - 0.375;


first_Index = 6*length(xLag_C1)+1;
Ncell_Lag_Pts = [length(xLag_C1) length(xLag_C2) length(xLag_C3) length(xLag_C4) length(xLag_C5) length(xLag_C6)];

% Combine CELL Geometry files into ONE vector for springs/beams (not necessary...just easier to count)
xLag_Cells = [xLag_C1 xLag_C2 xLag_C3 xLag_C4 xLag_C5 xLag_C6];
yLag_Cells = [yLag_C1 yLag_C2 yLag_C3 yLag_C4 yLag_C5 yLag_C6];
