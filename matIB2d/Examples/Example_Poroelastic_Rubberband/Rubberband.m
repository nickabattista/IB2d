...
% Prints .porous file!
alpha = 250000.0;      % Brinkman Coefficient
print_Lagrangian_Poroelasticity(xLag,alpha,struct_name)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION: -prints POROELASTICITY points to a file called rubberband.poroelastic
%           -alpha is the Brinkman constant
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function print_Lagrangian_Poroelasticity(xLag,alpha,struct_name)

    N = length(xLag);

    porous_fid = fopen([struct_name '.poroelastic'], 'w');
