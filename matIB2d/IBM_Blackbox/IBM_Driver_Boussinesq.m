...
fprintf('\n\n --> Using BOUSSINESQ approximation for density fluctuations\n');
...
if boussinesq_Yes == 1
    ...
    % Saves initial background ambient fluid density
    rho0 = rho;  
...
while current_time < T_FINAL
    ...
    if boussinesq_Yes == 1
        Fxh = Fxh + fBouss_X;
        Fyh = Fyh + fBouss_Y;
        rho = rho0*(1-exp_Coeff*laplacian_C);
    ...
    if concentration_Yes == 1
       [C,laplacian_C] = please_Update_Adv_Diff_Concentration(C,dt,dx,dy,U,V,kDiffusion); 
    end
