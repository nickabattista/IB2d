...
try
    ...
    if find(strcmp({Lag_Struct_Input{:,1}},'source')) > 0
        Lag_Struct_Params(20) = Lag_Struct_Input{find(strcmp({Lag_Struct_Input{:,1}},'source')),2};
    else
    ...
    if find(strcmp({Lag_Struct_Input{:,1}},'k_source')) > 0
        Lag_Struct_Params(21) = Lag_Struct_Input{find(strcmp({Lag_Struct_Input{:,1}},'k_source')),2};
    else
