...
electro_phys_Yes = model_Info(23);  % Electrophysiology (FitzHugh-Nagumo): 0 (for no) or 1 (for yes)
d_Springs_Yes = model_Info(24);     % Damped Springs: 0 (for no) or 1 (for yes)
gen_force_Yes = model_Info(28);     % General User-Defined Force: 0 (for no) or 1 (for yes)
poroelastic_Yes = model_Info(29);   % Poroelastic Media: 0 (for no) or 1 (for yes)
coagulation_Yes = model_Info(30);   % Coagulation Model: 0 (for no) or 1 (for yes)
