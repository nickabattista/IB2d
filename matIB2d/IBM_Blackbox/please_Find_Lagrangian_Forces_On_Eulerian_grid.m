...
electro_phys_Yes = model_Info(24);  % Electrophysiology (FitzHugh-Nagumo): 0 (for no) or 1 (for yes)
d_Springs_Yes = model_Info(25);     % Damped Springs: 0 (for no) or 1 (for yes)
gen_force_Yes = model_Info(29);     % General User-Defined Force: 0 (for no) or 1 (for yes)
poroelastic_Yes = model_Info(30);   % Poroelastic Media: 0 (for no) or 1 (for yes)
coagulation_Yes = model_Info(31);   % Coagulation Model: 0 (for no) or 1 (for yes)
